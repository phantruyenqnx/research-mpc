...
t=np.arange(0,20+Ts*innerDyn_length,Ts*innerDyn_length) # time from 0 to 100 seconds, sample time (Ts=0.4 second)
...
class mpc_custom:
    ...
    def posXY_model(self, U1):
        ...
        Ad=np.identity(np.size(A,1))+Ts_posXY*A
        Bd=Ts_posXY*B
        Cd=C
